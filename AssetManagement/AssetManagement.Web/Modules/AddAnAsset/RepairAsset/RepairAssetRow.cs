...
namespace AssetManagement.AddAnAsset.Entities
{
    ...
    [ConnectionKey("Default"), Module("AddAnAsset"), TableName("[dbo].[RepairAsset]")]
    [DisplayName("Repair Asset"), InstanceName("Repair Asset")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class RepairAssetRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Schedule Date"), NotNull]
        ...
        [DisplayName("Assigned To"), QuickSearch]
        ...
        [DisplayName("Repair Cost"), Size(19), Scale(4)]
        ...
        {
            get { return Fields.AssignedTo; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public RepairAssetRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public DateTimeField ScheduleDate;
            public StringField AssignedTo;
            public DateTimeField DateCompleted;
            public DecimalField RepairCost;

...
namespace AssetManagement.AddAnAsset.Entities
{
    ...
    [ConnectionKey("Default"), Module("AddAnAsset"), TableName("[dbo].[DisposeAsset]")]
    [DisplayName("Dispose Asset"), InstanceName("Dispose Asset")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class DisposeAssetRow : Row, IIdRow, INameRow
    {
        [DisplayName("Dispose Id"), Identity]
        public Int32? DisposeId
        {
            get { return Fields.DisposeId[this]; }
            set { Fields.DisposeId[this] = value; }
        }

        [DisplayName("Date Disposed"), NotNull]
        public DateTime? DateDisposed
        {
            get { return Fields.DateDisposed[this]; }
            set { Fields.DateDisposed[this] = value; }
        }

        [DisplayName("Dispose To"), Size(200), QuickSearch]
        public String DisposeTo
        {
            get { return Fields.DisposeTo[this]; }
            set { Fields.DisposeTo[this] = value; }
        }
        ...
        {
            get { return Fields.DisposeId; }
        }

        StringField INameRow.NameField
        {
            get { return Fields.DisposeTo; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public DisposeAssetRow()
            : base(Fields)
        {
        }
        ...
        {
            public Int32Field DisposeId;
            public DateTimeField DateDisposed;
            public StringField DisposeTo;

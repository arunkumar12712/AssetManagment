...
namespace AssetManagement.AddAnAsset.Entities
{
    ...
    [ConnectionKey("Default"), Module("AddAnAsset"), TableName("[dbo].[BrokenAsset]")]
    [DisplayName("Broken Asset"), InstanceName("Broken Asset")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class BrokenAssetRow : Row, IIdRow, INameRow
    {
        [DisplayName("Broken Id"), Identity]
        public Int32? BrokenId
        {
            get { return Fields.BrokenId[this]; }
            set { Fields.BrokenId[this] = value; }
        }

        [DisplayName("Date Broken"), NotNull]
        public DateTime? DateBroken
        {
            get { return Fields.DateBroken[this]; }
            set { Fields.DateBroken[this] = value; }
        }
        ...
        {
            public Int32Field BrokenId;
            public DateTimeField DateBroken;

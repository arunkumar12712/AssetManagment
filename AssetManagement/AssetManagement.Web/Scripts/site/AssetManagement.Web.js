...
(function (AssetManagement) {
    ...
    })(BasicSamples = AssetManagement.BasicSamples || (AssetManagement.BasicSamples = {}));
})(AssetManagement || (AssetManagement = {}));
var AssetManagement;
(function (AssetManagement) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = AssetManagement.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = AssetManagement.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = AssetManagement.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (AssetManagement) {
    ...
    })(Northwind = AssetManagement.Northwind || (AssetManagement.Northwind = {}));
})(AssetManagement || (AssetManagement = {}));
var AssetManagement;
(function (AssetManagement) {
    var Northwind;
...
(function (AssetManagement) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'AssetManagement.Northwind.Gender', 'AssetManagement.Northwind.Entities.Gender');
    })(Northwind = AssetManagement.Northwind || (AssetManagement.Northwind = {}));
})(AssetManagement || (AssetManagement = {}));
var AssetManagement;
(function (AssetManagement) {
...
(function (AssetManagement) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'AssetManagement.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = AssetManagement.Northwind || (AssetManagement.Northwind = {}));
})(AssetManagement || (AssetManagement = {}));
var AssetManagement;
(function (AssetManagement) {
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(AssetManagement.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(AssetManagement.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(AssetManagement.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(AssetManagement.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        AssetManagement.Common.ReportHelper.execute({
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: AssetManagement.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: AssetManagement.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new AssetManagement.Northwind.OrderDialog();
                        ...
                        var chai = AssetManagement.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = AssetManagement.Northwind.EmployeeRow.getLookup().items
        ...
        }(AssetManagement.Northwind.OrderGrid));
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(AssetManagement.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(AssetManagement.Northwind.OrderDialog));
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    AssetManagement.Northwind.CategoryService.Retrieve({
        ...
        }(AssetManagement.Northwind.CategoryDialog));
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(AssetManagement.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(AssetManagement.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new AssetManagement.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                AssetManagement.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(AssetManagement.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    AssetManagement.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(AssetManagement.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(AssetManagement.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    AssetManagement.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return AssetManagement.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return AssetManagement.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return AssetManagement.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return AssetManagement.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return AssetManagement.LanguageList.getValue();
            };
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(AssetManagement.Northwind.SupplierDialog));
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(AssetManagement.Northwind.SupplierGrid));
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return AssetManagement.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return AssetManagement.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return AssetManagement.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return AssetManagement.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return AssetManagement.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                AssetManagement.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    AssetManagement.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(AssetManagement.Northwind.CustomerDialog));
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(AssetManagement.Northwind.CustomerGrid));
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = AssetManagement.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return AssetManagement.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(AssetManagement.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return AssetManagement.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new AssetManagement.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(AssetManagement.Northwind.OrderDetailDialog));
...
(function (AssetManagement) {
    ...
    (function (Northwind) {
        ...
        }(AssetManagement.Common.GridEditorBase));
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(AssetManagement.Northwind.OrderDetailsEditor));
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return AssetManagement.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return AssetManagement.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return AssetManagement.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return AssetManagement.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return AssetManagement.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        ...
        }(AssetManagement.Common.BulkServiceAction));
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return AssetManagement.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return AssetManagement.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return AssetManagement.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return AssetManagement.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(AssetManagement.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new AssetManagement.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new AssetManagement.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new AssetManagement.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (AssetManagement) {
    ...
    AssetManagement.SelectableEntityGrid = SelectableEntityGrid;
})(AssetManagement || (AssetManagement = {}));
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return AssetManagement.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return AssetManagement.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return AssetManagement.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return AssetManagement.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(AssetManagement.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = AssetManagement.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            AssetManagement.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return AssetManagement.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return AssetManagement.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return AssetManagement.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return AssetManagement.Northwind.ProductService.baseUrl; };
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return AssetManagement.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return AssetManagement.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return AssetManagement.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return AssetManagement.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return AssetManagement.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return AssetManagement.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (AssetManagement) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return AssetManagement.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return AssetManagement.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return AssetManagement.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: AssetManagement.Authorization.userDefinition.DisplayName,
